...
<head>
    ...
    <title>Qian Kaihua's Index</title>
    <!-- Stylesheets -->
...
<body >
				...
				<div class="row">
					...
					<div class="col-sm-6">
						...
						<div class="iconboxleft">
							...
							<div class="iconboxleft-text">
								<h3 class="iconboxleft-title">Plugin Development</h3>
					...
					<div class="col-sm-6">
						...
						<div class="iconboxleft">
							...
							<div class="iconboxleft-text">
								<h3 class="iconboxleft-title">Blogs</h3>
								<div class="iconboxleft-desc">
									Thus, then, one of our own noble stamp, even a whaleman, is the tutelary guardian of England.
								</div>
							</div>
				...
				<div class="row">
					...
					<div class="col-sm-6">
						...
						<div class="iconboxleft">
							...
							<div class="iconboxleft-text">
								<h3 class="iconboxleft-title">Multingual</h3>
								<div class="iconboxleft-desc">
									Thus, then, one of our own noble stamp, even a whaleman, is the tutelary guardian of England.
								</div>
							</div>
					...
					<div class="col-sm-6">
						...
						<div class="iconboxleft wow fadeInUp animated" data-wow-delay=".2s" style="visibility: visible; -webkit-animation: fadeInUp 0.2s;">
							...
							<div class="iconboxleft-text">
								<h3 class="iconboxleft-title">Valid Code</h3>
								<div class="iconboxleft-desc">
									Thus, then, one of our own noble stamp, even a whaleman, is the tutelary guardian of England.
								</div>
							</div>
                    ...
                    <div class="row">
                        <div class="col-md-3 col-sm-6">
                            <div class="panel panel-default">
                                <header class="panel-heading">
                                    <h1>Beginner</h1>
                                    <div class="the-price">$0 <span class="subscript">/ month</span></div>
                                </header>
                                <div class="panel-body">
                                    <table class="table">
                                        <tbody>
                                            ...
                                            <tr><td>2 Features</td></tr>
                                            <tr class="active"><td>100GB Bandwidth</td></tr>
                                            <tr><td>Customer Support</td></tr>
                                            <tr class="active"><td>Yearly Reports</td></tr>
                                        </tbody>
                                    </table>
                                </div>
                                <footer class="panel-footer"><a href="#" class="btn btn-small">Sign up now</a></footer>
                            </div>
                        </div>
                        <div class="col-md-3 col-sm-6">
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    <table class="table">
                                        <tbody>
                                            ...
                                            <tr><td>10 Features</td></tr>
                                            <tr class="active"><td>1TB Bandwidth</td></tr>
                                            <tr><td>Customer Support</td></tr>
                                            <tr class="active"><td>Quarterly Reports</td></tr>
                                        </tbody>
                                    </table>
                                </div>
                                <footer class="panel-footer"><a href="#" class="btn btn-small">Sign up now</a></footer>
                        ...
                        <div class="col-md-3 col-sm-6">
                            <div class="panel panel-primary">
                                <header class="panel-heading">
                                    <h1>Hot!</h1>
                                    <div class="the-price">$15 <span class="subscript">/ month</span></div>
                                </header>
                                <div class="panel-body">
                                    <table class="table">
                                        <tbody>
                                            <tr><td>20 Account</td></tr>
                                            <tr class="active"><td>50 Project</td></tr>
                                            <tr><td>100 Features</td></tr>
                                            <tr class="active"><td>100TB Bandwidth</td></tr>
                                            <tr><td>Priority Customer Services</td></tr>
                                            <tr class="active"><td>Weekly Reports</td></tr>
                                        </tbody>
                                    </table>
                                </div>
                                <footer class="panel-footer"><a href="#" class="btn btn-red">Sign up now</a></footer>
                            </div>
                        </div>
                        <div class="col-md-3 col-sm-6">
                            <div class="panel panel-default">
                                <header class="panel-heading">
                                    <h1>Enterprise</h1>
                                    <div class="the-price">$30 <span class="subscript">/ month</span></div>
                                </header>
                                <div class="panel-body">
                                    
                                    <table class="table">
                                        <tbody>
                                            <tr><td>Unlimited Account</td></tr>
                                            <tr class="active"><td>Unlimited Project</td></tr>
                                            <tr><td>Unlimited Features</td></tr>
                                            <tr class="active"><td>Unlimited Bandwidth</td></tr>
                                            <tr><td>Priority Customer Services</td></tr>
                                            <tr class="active"><td>Daily Reports</td></tr>
                                        </tbody>
                                    </table>
                                </div>
                                <footer class="panel-footer"><a href="#" class="btn btn-small">Sign up now</a></footer>
    ...
    <footer class="footer">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    Frittt - A Free Responsive Bootstrap 3 Template &copy; 2014 - More Templates <a href="http://www.cssmoban.com/" target="_blank" title="模板之家">模板之家</a> - Collect from <a href="http://www.cssmoban.com/" title="网页模板" target="_blank">网页模板</a>
                </div>
            </div>
        </div>
    </footer>
